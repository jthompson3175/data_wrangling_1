...
Selecting is literally only for changing/selecting the columns that you
have.
...
Double equals is a logical oprator. It asks a quesiton: are these two
things equal? If so (true), keep it. Keeps the rows for which the
logical quesiton is true.
